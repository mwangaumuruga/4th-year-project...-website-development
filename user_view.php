...
<body>
	...
	<table style="width: 100%;">
		<tr>
			<td id="td1" style="padding: 10px; font-size: 48px; position: sticky; z-index: 1"><p style="color: #e6b800; display: inline;">My</p> Profile</td>
			<td id="td1" style="font-size: 25px; text-align: right;">Hello, <?php echo $row[2]; ?></td>
		</tr>
	</table>
	<ul>
		<li><a href="user_view.php">My Profile</a></li>
		<li><a href="bookroom.php">Order A meal</a></li>
		<li><a href="user_room_status.php">Order Status</a></li>
